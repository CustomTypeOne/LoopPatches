...
**README last updated on 19-Feb-2023**
...
A new branch, dev-b36573a_20230218 was created from dev, i.e., dev-commit_date. That branch will work up through commit b36573a and probably with version prior to 18-Feb-2023.
...
```
cd Loop
curl https://raw.githubusercontent.com/CustomTypeOne/LoopPatches/dev-b36573a_20230218/LoopPatch.txt | git apply
cd ..
cd LoopKit
curl https://raw.githubusercontent.com/CustomTypeOne/LoopPatches/dev-b36573a_20230218/LoopkitPatch.txt | git apply
cd ..
